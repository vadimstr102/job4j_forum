                ...
                <div class="card-body">
                    <form action="<c:url value='/save?id=${post.id}'/>" method='POST'>
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" id="name" name="name" placeholder="Введите название темы" value="${post.name}">
                        </div>
                        <div class="form-group mb-3">
                            <label for="description" class="form-label">Описание темы</label>
                            <input type="text" class="form-control" id="description" name="description" placeholder="Введите описание темы"
